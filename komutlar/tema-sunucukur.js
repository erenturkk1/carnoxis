...
message.guild.channels.create('💧 ・ Nehir', {type: 'voice'}).then(a => a.setParent(parent.id) && a.setUserLimit(15));
message.guild.channels.create('🌲・ Orman', {type: 'voice'}).then(a => a.setParent(parent.id) && a.setUserLimit(15));
...
message.guild.channels.create('🔓 ・ Kafana Göre', {type: 'voice'}).then(a => a.setParent(parent.id) && a.setUserLimit(10));
