...
.setColor(0x36393F)
.setDescription(`<a:twitchbit:793899916614828062> Kayıt olunca otomatik alınacak rol sıfırlandı!`)
...
.setColor(0x36393F)
.setDescription(`<a:twitchbit:793899916614828062> Kayıt olunca alınacak rolü belirtiniz!`)
.setThumbnail(client.user.avatarURL())
.setFooter(`Carnoxis`)
...
.setTitle(`${client.user.username} | Alınacak rolü ayarlama komutu.`)
.setColor(0x36393F)
.setDescription(`<a:twitchbit:793899916614828062> Kayıt olunca otomatik alınacak rol başarıyla ${rol} olarak ayarlandı!`)
.setThumbnail(client.user.avatarURL)
.setFooter(`Carnoxis`)
