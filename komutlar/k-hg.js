...
.setColor(0x36393F)
.setDescription(`<a:twitchbit:793899916614828062> Hoş geldin kanalı başarıyla sıfırlandı!`)
...
.setColor(0x36393F)
.setDescription(`<a:twitchbit:793899916614828062> Hoş geldin kanalı belirtiniz!`)
.setThumbnail(client.user.avatarURL())
.setFooter(`Carnoxis`)
...
.setTitle(`${client.user.username} | Hoş geldin kanalını ayarlama komutu.`)
.setColor(0x36393F)
.setDescription(`<a:twitchbit:793899916614828062> Hoş geldin kanalı ${kanal} olarak ayarlandı!`)
.setThumbnail(client.user.avatarURL())
.setFooter(`Carnoxis`)
