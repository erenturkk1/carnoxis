...
.setColor(0x36393F)
.setDescription(`<a:twitchbit:793899916614828062> Kayıt olunacak kanal başarıyla sıfırlandı!`)
...
.setColor(0x36393F)
.setDescription(`<a:twitchbit:793899916614828062> Kayıt olunacak kanalı belirtiniz!`)
.setThumbnail(client.user.avatarURL())
.setFooter(`Carnoxis`)
...
.setTitle(`${client.user.username} | Kayıt kanal ayarlama komutu.`)
.setColor(0x36393F)
.setDescription(`<a:twitchbit:793899916614828062> Kayıt olunacak kanal ${kanal} olarak ayarlandı!`)
.setThumbnail(client.user.avatarURL())
.setFooter(`Carnoxis`)
