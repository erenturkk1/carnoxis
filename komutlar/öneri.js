...
exports.run = (client, message, args) => {
    ...
    if(!öneri) return message.channel.send("Bir öneri belirtmelisin. **NOT** deneme,sa,baksanıza,alo vb. gibi şeyler yazmak yasak. Aksi takdirde botdan yasaklanırsınız!!. ")
